 ...
 *
 * Canonical domain layer for chart category definitions, voting weight
 * configurations, and eligibility logic.
 *
 * Zero React dependencies; zero external I/O.
 *
 * All category definitions, metadata, and pure business-logic functions live
 * here. The legacy `src/lib/categories.ts` shim re-exports from this module
 * for backward compatibility — new code should always import from
 * `@/domain/categories`.
 */
